...
from facerecognition.facecatch.load_data import load_dataset, resize_image, IMAGE_SIZE
...
if __name__ == '__main__':
    dataset = Dataset('../face_images/')
    dataset.load()

    model = Model()
    model.build_model(dataset)
    model.train(dataset)
    model.save_model(file_path='../model/zhouwei.face.model.h5')
...
#     # 评估模型
#     model = Model()
#     model.load_model(file_path='./model/zhouwei.face.model.h5')
#     model.evaluate(dataset)
